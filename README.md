...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fev4ple.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fev4ple.containers.anotherwebservice.com/
...
```
git clone git@github.com:noehmeier/container-fev4ple.git
cd container-fev4ple
```
...
```
docker attach container-fev4ple
```
